...
${member.workDescription ? `<p class="text-sm text-leaf font-medium mt-1">${member.workDescription}</p>` : ''}
        ...
        members.forEach((member) => {
          ...
          card.innerHTML = `
                <div class="grid grid-cols-[180px_60px_1fr] items-center gap-2">
                    <span class="font-medium text-gray-800 dark:text-white truncate">${member.name}</span>
                    <div class="flex items-center gap-2">
